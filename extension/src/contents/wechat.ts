...
function done(msg: string) {
  chrome.storage.local.set({
    [`contentbridge_result_${PLATFORM}`]: { platform: PLATFORM, platformName: NAME, success: true, message: msg },
  });
...
function fail(msg: string) {
  chrome.storage.local.set({
    [`contentbridge_result_${PLATFORM}`]: { platform: PLATFORM, platformName: NAME, success: false, message: msg, error: msg },
  });
