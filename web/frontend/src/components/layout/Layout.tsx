  ...
  return (
    <div className="relative flex h-screen overflow-hidden bg-gradient-to-br from-[#fafaf7] via-[#f7f8f4] to-[#fafaf8]">
      ...
      <div className="absolute top-4 right-4 z-50 flex items-center gap-2">
        <button
          onClick={toggle}
          className="flex items-center gap-1.5 rounded-full border border-[rgba(49,56,45,0.1)] bg-white/80 backdrop-blur-sm px-3 py-1.5 text-[11px] text-[var(--ink-soft)] hover:bg-white hover:text-[var(--ink)] hover:border-[rgba(49,56,45,0.2)] transition-all"
        >
          <X size={12} />
          退出演示
        </button>
        <button
          ...
          className="flex items-center gap-1.5 rounded-full border border-[rgba(49,56,45,0.08)] bg-white/60 backdrop-blur-sm px-3 py-1.5 text-[11px] text-[var(--ink-soft)] hover:bg-white hover:border-[rgba(49,56,45,0.15)] transition-all"
        >
          <Maximize size={12} />
          全屏
        </button>
